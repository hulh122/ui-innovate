...
UI design exploration for [vm0](https://github.com/vm0-ai/vm0) GitHub issues.

## How it works

1. A GitHub issue describes a UI change request
2. The [`/ui-innovate`](https://github.com/vm0-ai/vm0/blob/main/.claude/skills/ui-innovate/skill.md) skill snapshots the current UI as a baseline using [freeze-dry](https://github.com/vm0-ai/freeze-dry-bundle)
...
- **[freeze-dry](https://github.com/vm0-ai/freeze-dry-bundle)** -- Captures live DOM as self-contained HTML (CSS inlined, images as data URIs)
